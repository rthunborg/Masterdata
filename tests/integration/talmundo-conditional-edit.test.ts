  ...
  describe('Employee Data Model Integration', () => {
    it('should have talmundo field in Employee type', () => {
      const mockEmployee: Employee = {
        ...
        is_terminated: false,
        is_archived: false,
        comments: null,        one_marked_at: new Date(Date.now() - 25 * 60 * 60 * 1000).toISOString(),
        talmundo: false, // Talmundo field should exist        created_at: '2025-01-01T00:00:00Z',
  ...
  describe('Validation Schema Integration', () => {
    it('should validate employee data with talmundo field', async () => {
      ...
      const validData = {
        ...
        omc_date: null,
        pe3_date: null,
        comments: null,        talmundo: false, // Should be valid when false        is_terminated: false,
        is_archived: false,
        termination_date: null,
        termination_reason: null,
      };
    ...
    it('should reject talmundo=true when One is false', async () => {
      ...
      const invalidData = {
        ...
        omc_date: null,
        pe3_date: null,
        comments: null,        talmundo: true, // Invalid - One is false        is_terminated: false,
        is_archived: false,
        termination_date: null,
        termination_reason: null,
      };
    ...
    it('should reject talmundo=true when One is yellow (< 24 hours)', async () => {
      ...
      const invalidData = {
        ...
        omc_date: null,
        pe3_date: null,
        comments: null,        one_marked_at: twelveHoursAgo,
    ...
    it('should accept talmundo=true when One is green (>= 24 hours)', async () => {
      ...
      const validData = {
        ...
        omc_date: null,
        pe3_date: null,
        comments: null,        one_marked_at: twentyFiveHoursAgo,
