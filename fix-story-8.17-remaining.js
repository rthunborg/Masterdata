...
const fixes = [
  ...
  // Fix date-capacity-concurrency.test.ts - Promise type issue
  {
    ...
    line: 469,
    search:
      /const result = await dateCapacityService\.getDateCapacityStatus\(\{\s+id: 'date-1',\s+\}\);/s,
  ...
  // Fix column-settings-table.test.tsx - add missing properties (2 instances)
  {
    ...
    line: 38,
    search:
      /(is_visible: true,\s+display_order: 0,\s+created_at: '2025-01-01T00:00:00Z',\s+updated_at: '2025-01-01T00:00:00Z',)/,
  ...
  },
  {
    ...
    line: 55,
    search:
      /(is_visible: true,\s+display_order: 1,\s+created_at: '2025-01-01T00:00:00Z',\s+updated_at: '2025-01-01T00:00:00Z',)/,
  ...
  // Fix column-config-repository.test.ts - add params to function calls (2 instances)
  {
    ...
    line: 324,
    search:
      /column_name: 'custom_column_1',\s+column_type: 'text',\s+role: UserRole\.SODEXO,/,
  ...
  },
  {
    ...
    line: 350,
    search:
      /column_name: 'custom_column_2',\s+column_type: 'text',\s+role: UserRole\.SODEXO,/,
