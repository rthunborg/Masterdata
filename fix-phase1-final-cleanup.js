...
let content = fs.readFileSync('tests/integration/api/important-dates.test.ts', 'utf8');
...
fs.writeFileSync('tests/integration/api/important-dates.test.ts', content, 'utf8');
...
['tests/integration/crewing-done-conditional.test.ts', 'tests/integration/talmundo-conditional-edit.test.ts'].forEach(file => {
...
content = fs.readFileSync('tests/integration/date-capacity-concurrency.test.ts', 'utf8');
...
fs.writeFileSync('tests/integration/date-capacity-concurrency.test.ts', content, 'utf8');
