...
- [x] **Task 4: Visual Regression Check** (AC: 5)
  - [x] Run local development server (`pnpm run dev`)
...
- [x] **Task 5: Run Automated Tests** (AC: 2, 5)
  - [x] Run test suite: `pnpm test` or `pnpm test`
...
- Run tests: `pnpm test` or `pnpm test`
- Watch mode: `pnpm test -- --watch`
- Single file: `pnpm test landing-page.test.tsx`
