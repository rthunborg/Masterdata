...
- Backup automation exists and the 2026-06-03 scheduled workflow completed successfully, including partial staging restore. A full restore drill of a production backup into a non-production target was verified on 2026-06-11 (`evidence/restore-drill-2026-06-11.md`). Still open: operational ownership confirmation and backup-failure alerting (the 2026-06-05 nightly run failed unnoticed; Story 22.12).
...
4. Full restore drill done (2026-06-11). Remaining: add backup-failure alerting and document RTO including auth-user re-provisioning (auth schema is outside logical backup scope).
