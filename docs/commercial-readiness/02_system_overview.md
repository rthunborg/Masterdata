...
| Room Assignment | ÖMC hotel room calculations | HR Admin, Recruiter workflows | `employees`, `important_dates`, RPC functions | `src/lib/services/room-assignment.ts`, `supabase/migrations/20250113000000_add_room_assignment_rpc.sql` | Verified |
