...
Prepared: 2026-06-03
Updated: 2026-09-15 — staging remains 67/67 after completed v67 acceptance; the Realtime fixture is complete and targeted Story 13.8 E2E verification passes at 413b6f8, while exact local Vitest/Playwright pass, and final gates remain open

Story 22.15 staging v67 is applied and verified: PR #100 head 0150d55b4aa359b19149fd6c288242809e14901b merged as ad9650ccfc8be412447a03847cc7ddfb372f8666, and the one forward migration applied with no repair. Staging history remains 67/67 with a strict 16/16 post-apply catalog; audit preservation, repayment aggregates and all four permission hashes are unchanged, while advisors retain only three classified performance WARN. The separately approved hosted staging fixture/RPC acceptance executed once on 2026-09-12: all 21 checks passed (0 failed, 0 skipped); all five exact trigger contracts matched; fixtures were absent, staffing and aggregate restoration held, and the final catalog remained 16/16. A clean baseline exposed the platform-default trigger ACL extension that immutable v67 rejects, so forward-only `20260910184840_reconcile_canonical_trigger_acl_prerequisite.sql` is pending reviewed staging `--include-all` dry run/apply; the repository target is 68 versions. Pushed candidate `5ec0228ea8605b411d25f2d00911dcf7b62b5b10` passed full Vitest 3,480/3,480, focused 89/89, and strict local fixtures 16/16 plus 16/16; named staging build passed (exit 0, 14.633s), forced production refusal and pause regression 26/26 passed, but the earlier historical Playwright attempt 3 failed (162 passed, 47 classified skips, 1 failed; exit 1; 1,091.088s) because the external local fixture lacks Realtime and returns WebSocket 404; Pre-merge local gates pass at test-only commit `413b6f809b708145df0e6518f49f5afbc04ebeca`; detailed results and retained failed attempts are in the dated ACL-prerequisite evidence. Production is 56 repair candidates plus 12 applies and remains paused; Story 22.15 is in-progress and Epic 23 is on hold.
...
| `26_environment_reconciliation_inventory.md` | Security, IT, reviewers | Current staging is 67/67 with strict 16/16 post-apply proof, verified preservation, and completed bounded 21-check hosted acceptance. The reviewed v68 ACL prerequisite is pending exact staging `--include-all`; production is provisional at 56 repair candidates plus 12 applies, so strict remaining failures keep it no-go and paused. |
...
- Supabase Auth session lifetime and MFA settings (dashboard-only). Preserve the dated 2026-06-14 57-migration/19-policy snapshot as historical. Current staging is 67/67 with no repair and strict 16/16 post-apply proof; sole pending v68 requires reviewed staging `--include-all`. Bounded hosted acceptance passed 21/21, while owner staging verification and production inventory remain open. Production stays paused. Leaked-password protection and CAPTCHA remain held under Epic 23 Story 23.4.
...
- Story 22.15 staging v67 was applied once with no repair; current history is 67/67 and strict post_apply passes 16/16. The sole reviewed pending staging execute is v68 `20260910184840`, through its exact `--include-all` dry run/apply; do not replay v67. Hosted fixture/RPC acceptance completed 21/21; fresh correction-candidate gates and review, owner staging verification, and production's 56-repair/12-apply plan remain governed by the runbook prerequisites and separate non-migration gates. See `17_blocker_remediation_tracker.md#tracker`.
