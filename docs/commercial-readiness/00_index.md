...
| `26_environment_reconciliation_inventory.md` | Security, IT, reviewers | Current staging is 67/67 with no pending version, strict 16/16 post-apply proof and verified preservation. Hosted fixture/RPC acceptance and owner staging verification remain open. Production is provisional at 57 repairs plus 10 applies after fresh inventory. |
...
- Supabase Auth session lifetime and MFA settings (dashboard-only). Preserve the dated 2026-06-14 57-migration/19-policy snapshot as historical. Current staging is 67/67 with no pending version or repair and strict 16/16 post-apply proof; hosted fixture/RPC acceptance, owner staging verification and production inventory remain open. Production stays paused. Leaked-password protection and CAPTCHA remain held under Epic 23 Story 23.4.
