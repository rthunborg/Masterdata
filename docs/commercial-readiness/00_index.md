...
Prepared: 2026-06-03
Updated: 2026-09-10 — dependency remediation and exact-head evidence recorded; fresh local gates and owner gates remain open

Current preparation is PR #96 at exact head `7826a339414fccf6694798ef039a2e1e4403a8b6`: 64 repository versions, one separately approved staging repair followed by six exact applies, and provisional production 57 catalog-proven repairs followed by seven applies after fresh inventory. Production remains paused; deployment, settings changes and reopening require separate owner decisions. The narrow dependency remediation returns the audit to 0 critical / 0 high / 1 accepted moderate (exit 1 solely for ExcelJS→UUID through 2026-09-30); fresh full local gates remain pending. See [current evidence](evidence/staging-reconciliation-and-pause-2026-09-09.md) and [pause safeguards](29_production_pause_release_safeguards.md).
...
| `26_environment_reconciliation_inventory.md` | Security, IT, reviewers | Dated Story 22.10 three-way drift inventory plus Story 22.15's 64-version manifest partition, catalog-proof requirements, exact staging/production repair/apply deltas, and 17-policy target. Story 22.10 staging writes remain historical; the Story 22.15 hosted delta is unapplied. Cutover steps: `docs/commercial-readiness/27_supabase_cutover_runbook.md`; change policy: `docs/commercial-readiness/28_migrations_only_change_policy.md` |
| `27_supabase_cutover_runbook.md` | Security, IT, operations | Manifest-governed sequence: fresh catalog proof, signed 57-row production ledger, exact explicit repairs, `db push --dry-run --skip-vault`, six staging/seven production applies, separate backup/maintenance/database-apply authorization while preserving the pause, and post-apply verification. No Story 22.15 hosted action has executed. |
...
- The 2026-09-09 Story 22.15 audit failure is historical. The 2026-09-10 narrow patch returns the audit to 0 critical / 0 high / 1 moderate, with exit 1 solely for the existing ExcelJS→UUID acceptance through 2026-09-30. No new waiver was added; fresh full local gates remain pending.
...
- Supabase Auth session lifetime and MFA settings (dashboard-only). Preserve the dated database states: Story 22.10 hosted staging was verified at 57 migrations/19 policies on 2026-06-14; the Story 22.15 repository has 64 versions and a 17-policy target. After fresh catalog proof, staging repairs only `20250113000000` and applies six versions; production requires fresh inventory, proof and separate approval for the 57-version repair list and seven applies. Production remains paused. Leaked-password protection + CAPTCHA remain Epic 23 Story 23.4.
