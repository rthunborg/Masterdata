...
export function createEmployeeSchemaWithMessages(t?: (key: string) => string) {
  ...
  return z.object({
    ...
    one: z.string().nullable().default(null),
    isps: z.string().nullable().default(null),
    photo: z.string().nullable().default(null),
    origo: z.string().nullable().default(null),
    loneiva: z.string().nullable().default(null),
    mail_lon: z.string().nullable().default(null),
    bankuppgifter: z.string().nullable().default(null),
    li: z.string().nullable().default(null),
    passport: z.string().nullable().default(null),
    kvitto_c17_18: z.string().nullable().default(null),
    c17: z.string().nullable().default(null),
    crewing_done: z.string().nullable().default(null),
...
export const csvImportEmployeeSchema = z.object({
  ...
  // New masterdata columns (Story 7.1) - all optional/nullable
  one: z.string().nullable().optional().or(z.literal("")),
  isps: z.string().nullable().optional().or(z.literal("")),
  photo: z.string().nullable().optional().or(z.literal("")),
  origo: z.string().nullable().optional().or(z.literal("")),
  loneiva: z.string().nullable().optional().or(z.literal("")),
  mail_lon: z.string().nullable().optional().or(z.literal("")),
  bankuppgifter: z.string().nullable().optional().or(z.literal("")),
  li: z.string().nullable().optional().or(z.literal("")),
  passport: z.string().nullable().optional().or(z.literal("")),
  kvitto_c17_18: z.string().nullable().optional().or(z.literal("")),
  c17: z.string().nullable().optional().or(z.literal("")),
  crewing_done: z.string().nullable().optional().or(z.literal("")),
  // System-managed fields with defaults
