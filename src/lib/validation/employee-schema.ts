...
function getBaseEmployeeSchemaObject(t?: (key: string) => string) {
  ...
  return z.object({
    ...
    // Story 8.13: Repayment tracking fields - boolean checkbox (null/false = unchecked, true = checked)
    // Only boolean | null so form/resolver types match (no "" in UpdateEmployeeInput)
