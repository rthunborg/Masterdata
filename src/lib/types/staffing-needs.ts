...
/** Explicit map from location to its i18n key under `staffingNeeds.*` */
export const LOCATION_I18N_KEYS: Record<StaffingLocation, string> = {
  'Göteborg': 'locationGoteborg',
  'Trelleborg': 'locationTrelleborg',
};
