    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          // Mobile: full-screen with safe areas, Tablet+: centered modal
          "inset-4 max-h-[calc(100vh-2rem)] overflow-y-auto",
          "md:inset-auto md:top-[50%] md:left-[50%] md:max-w-[90vw] md:translate-x-[-50%] md:translate-y-[-50%] md:max-h-[85vh]",
          "lg:max-w-2xl",
          className
        )}
        {...props}
